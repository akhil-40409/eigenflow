"""Feynman equations + special functions. One entry point: make_dataset."""
...
def make_dataset(
    ...
    *,
    ...
    """Feynman id (e.g. ``I.12.1``) or special id (e.g. ``sinc``)."""
    ...
    if task_id in FEYNMAN_EQUATIONS:
        ...
        raise ValueError(
            ...
            f"Feynman: {list(FEYNMAN_EQUATIONS)}; special: {list(SPECIAL_FUNCTIONS)}"
        )
    data = train_val_test_split(X, y, k_split, train_frac=train_frac, val_frac=val_frac)
